 ...
 */
class SocialMediaIcons extends AbstractBlock {
	/**
	 ...
	 * @var string
	 */
	protected static $name = 'Social_Media_Icons';
	/**
	 ...
	 * @var string
	 */
	protected static $description = 'Show the social media icons added in Yoast';
	/**
	 ...
	 * @var array
	 */
	protected static $keywords = array( 'Social', 'Media', 'Some' );
